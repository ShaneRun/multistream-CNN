...
parser.add_argument('--init_method', type=str, default="", help='Initialization method')
...
parser.add_argument('--f_min', type=float, default=0, help='minimum frequency')
parser.add_argument('--f_max', type=float, default=None, help='maximum frequency')
parser.add_argument('--n_mels', type=int, default=40, help='Number of mel filterbanks')
parser.add_argument('--log_input', type=bool, default=False, help='Log input features')
parser.add_argument('--output_file',    type=str,   default="scores.txt",     help='output file')
...
scorefile = open(result_save_path + "/train_scores.txt", "a+")
...
while (1):
    ...
    if it % args.test_interval == 0:
        ...
        print(time.strftime("%Y-%m-%d %H:%M:%S"),
              "LR %f, TEER/TAcc %2.2f, TLOSS %f, VEER %2.4f" % (max(clr), traineer, loss, result[1]))
        scorefile.write(
            "IT %d, LR %f, TEER/TAcc %2.2f, TLOSS %f, VEER %2.4f\n" % (it, max(clr), traineer, loss, result[1]))
